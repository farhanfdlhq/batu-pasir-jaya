...
import { CheckCircleIcon, ChevronRightIcon } from '../components/IconComponents';
  ...
  return (
    <div className="bg-white">
      ...
      <section className="relative bg-secondary text-white h-[60vh] min-h-[400px] flex items-center">
        ...
        <img src="https://picsum.photos/seed/hero-bg/1920/1080" alt="Construction site" className="absolute inset-0 w-full h-full object-cover"/>
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center">
          ...
          <p className="text-lg md:text-xl max-w-3xl mx-auto mb-8 text-slate-200">
            Menyediakan material bangunan terbaik untuk proyek rumah pribadi hingga konstruksi skala besar.
          </p>
      ...
      <section className="py-16 bg-slate-50">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold text-secondary">Produk Unggulan</h2>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
           ...
           <div className="text-center mt-12">
            <Link to="/catalog" className="text-primary font-semibold hover:text-primary-dark transition-colors flex items-center justify-center group">
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold text-secondary">Keunggulan Kami</h2>
            <p className="mt-4 text-lg text-slate-600 max-w-2xl mx-auto">
              Alasan mengapa Anda harus memilih Batu Pasir Jaya sebagai mitra konstruksi Anda.
            </p>
          </div>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
            {advantages.map((advantage, index) => (
              <div key={index} className="flex items-start p-6 bg-slate-50 rounded-lg">
                ...
                <div>
                  <h3 className="text-lg font-semibold text-secondary">{advantage}</h3>
                  <p className="mt-1 text-slate-500">Kami berkomitmen memberikan yang terbaik untuk setiap aspek layanan.</p>
                </div>
              </div>
            ))}
          </div>
      ...
      <section className="bg-secondary">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-16 text-center">
            <h2 className="text-3xl font-bold text-white">Butuh Estimasi Material Untuk Proyek Anda?</h2>
            <p className="mt-4 text-lg text-slate-300 max-w-3xl mx-auto">
                Gunakan AI Estimator kami untuk mendapatkan perkiraan kebutuhan material dengan cepat dan mudah.
            </p>
            <div className="mt-8">
                <Link
                to="/estimator"

      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-3 lg:col-span-1">
            <NavLink to="/" className="flex items-center space-x-2 text-white mb-4">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><NavLink to="/catalog" className="hover:text-primary transition-colors">Katalog Produk</NavLink></li>
              <li><NavLink to="/about" className="hover:text-primary transition-colors">Tentang Kami</NavLink></li>
              <li><NavLink to="/contact" className="hover:text-primary transition-colors">Kontak</NavLink></li>
               <li><NavLink to="/estimator" className="hover:text-primary transition-colors">AI Estimator</NavLink></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm">
              <li className="flex items-start">
                ...
                <span>Jl. Contoh Raya No. 1, Jakarta, 10110, Indonesia</span>
              </li>
              <li className="flex items-center">
                <PhoneIcon className="h-5 w-5 mr-3 text-primary" />
                <a href="tel:+628123456789" className="hover:text-primary transition-colors">+62-8123456789</a>
              </li>
              <li className="flex items-center">
                <MailIcon className="h-5 w-5 mr-3 text-primary" />
                <a href="mailto:sales@batupasirjaya.com" className="hover:text-primary transition-colors">sales@batupasirjaya.com</a>
              </li>
            </ul>
          </div>
        ...
        <div className="mt-12 border-t border-slate-700 pt-8 text-center text-sm text-slate-500">
          <p>&copy; {new Date().getFullYear()} Batu Pasir Jaya. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
